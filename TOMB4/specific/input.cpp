...
int16_t keyboard_layout[INPUT_LAYOUT_COUNT][INPUT_ACTION_COUNT] = {
	{
...
int32_t conflict[INPUT_ACTION_COUNT];
int32_t input;
int32_t linput;
int32_t dbinput;
int32_t inputBusy;
...
int32_t S_UpdateInput() {
	static int32_t LookCnt;
	static int32_t med_hotkey_timer;
	int16_t state;
	...
	if (lara.gun_status == LG_READY) {
		savegame.AutoTarget = (uint8_t)App.AutoTarget;
